        ...
        @if ($data['current_class'] === null)
            <div class="portal-card">
                <p class="portal-muted" style="margin:0;">
                    {{ __('Jadwal belum tersedia karena anak belum memiliki kelas pada tahun ajaran yang berjalan.') }}
                </p>
            </div>
        @else
            <div class="portal-card" style="margin-bottom:1rem;">
            ...
            <div class="portal-card">
                ...
                @if ($week->isEmpty())
                    <p class="portal-muted" style="margin:0;">{{ __('Belum ada jadwal untuk kelas ini.') }}</p>
                @else
