...
class ListGrades extends ListRecords
{
    ...
    {
        return [
            Actions\CreateAction::make()->label('Input Nilai Satuan'),
            ...
            Actions\Action::make('import')
                ...
                ->color('gray')
                ->visible(fn () => Auth::user()?->can('import', Grade::class))
                ->modalDescription('Berkas cukup memuat dua kolom: nis dan nilai — tombol "Unduh Template" menyediakan berkas kosongnya. Kelas, komponen, dan jenis penilaian diambil dari pilihan di bawah.')
                ->form([
